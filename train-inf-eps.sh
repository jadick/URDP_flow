...
python train-inf-eps.py --total_epochs 300\
			...
			--step 20 \
			--single_bit 0 \
                        --pre_path 'saved_models/inf-eps/step_20/inf-2|lambdaJD_$2|lambdaFMD_0.0|lambdaNEW_0.0|lambdaMSE_1.0|dataset_mmnist_4_axis_random_sample_step'\
                        --path './data/' \
