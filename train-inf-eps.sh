...
python train-inf-eps.py --total_epochs 300 \
			...
			--step 15 \
			--single_bit 0 \
                        --pre_path 'saved_models/inf-eps/step_[11, 5]/inf-2|lambdaJD_0.0|lambdaFMD_0.0|lambdaNEW_0.0|lambdaMSE_1.0|dataset_mmnist_unidir_$2_axis' \
                        --path './data/' \
			--dataset 'mmnist_unidir_$2_axis'\
			--first_train True
